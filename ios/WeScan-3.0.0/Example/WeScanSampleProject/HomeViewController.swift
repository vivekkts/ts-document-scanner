...
final class HomeViewController: UIViewController {
    ...
    @objc func scanOrSelectImage(_ sender: UIButton) {
        ...
        let newAction = UIAlertAction(title: "A new scan", style: .default) { _ in
            ...
            documentScannerViewController.rootView.onSave = { url in
                print("URL RECEIVED", url)
            }
            
            documentScannerViewController.modalPresentationStyle = .fullScreen
            self.present(documentScannerViewController, animated: true, completion: nil)
        }
...
//        let documentScannerView = DocumentScannerHome(selectedImage: image)
//        let documentScannerViewController = UIHostingController(rootView: documentScannerView)
//        
//        documentScannerViewController.rootView.onSaveToPDF = { url in
//            print("URL RECEIVED", url)
//        }
//        
//        documentScannerViewController.modalPresentationStyle = .fullScreen
