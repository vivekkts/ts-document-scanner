...
import biz.cunning.cunning_document_scanner.fallback.utils.DocumentProviderUtil
...
class DocumentScannerActivity : AppCompatActivity() {
    ...
    private val cameraUtil = CameraUtil(
        ...
        onPhotoCaptureSuccess = {
            ...
            document = Document(documentPath, photo.width, photo.height, corners)
    ...
    private val documentUtil = DocumentProviderUtil(
        ...
        onDocumentSelectSuccess = {
            filePath ->
                ...
                document = Document(filePath, photo.width, photo.height, corners)
